...
echo "2. Pull a small model: $BASE_DIR/scripts/pull-model.sh phi2"
...
echo "  - phi2            (small but capable)"
echo "  - gemma:2b        (very small)"
echo "  - tinyllama       (very small)"
echo "  - neural-chat:7b  (medium size)"
